...
public class DiscordMessageHandler : ISsePayloadReceiver, ISsePayloadEmitter
{
    ...
    {
        return eventId == "discord_message" && SseClient.Instance.Config.ReceiveDiscordMessages;
    }
    ...
    public void Receive(string eventId, SsePayload payload)
    {
        SseUtils.PrintSseChat(new XivChatEntry
        {
            ...
            Type = SseClient.Instance.Config.DiscordMessagesType
        });
    }

    public bool CanEmit(XivChatType chatType) => SseClient.Instance.Config.SendFcMessages;
