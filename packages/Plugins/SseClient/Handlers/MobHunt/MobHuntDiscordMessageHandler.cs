...
namespace Divination.SseClient.Handlers.MobHunt
{
    public class MobHuntDiscordMessageHandler : ISsePayloadReceiver
    {
        ...
        {
            return eventId == "mobhunt_discord" && SseClientPlugin.Instance.Config.ReceiveMobHuntDiscordMessages;
        }
        ...
        public void Receive(string eventId, SsePayload payload)
        {
            ...
            {
                Type = SseClientPlugin.Instance.Config.MobHuntDiscordMessagesType,
                Name = payload.Sender,
