...
public class PowerUtils : DivinationPlugin<PowerUtils>, IDalamudPlugin, ICommandSupport
{
    public PowerUtils(DalamudPluginInterface pluginInterface) : base(pluginInterface)
    {
    }
