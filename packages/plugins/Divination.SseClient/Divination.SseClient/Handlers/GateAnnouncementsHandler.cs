...
namespace Divination.SseClient.Handlers
{
    public class GateAnnouncementsHandler : ISsePayloadReceiver, ISsePayloadEmitter
    {
        ...
        {
            return eventId == EventId && SseClientPlugin.Instance.Config.ReceiveGateAnnouncements;
        }
        ...
        public bool CanEmit(XivChatType chatType) => SseClientPlugin.Instance.Config.SendGateAnnouncements;
