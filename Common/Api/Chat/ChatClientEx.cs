...
{
    public static void Print(this IChatClient client, List<Payload> payloads, string? sender = null, XivChatType? type = null)
    {
        client.Print(new SeString(payloads), sender, type);
    }

    public static void Print(this IChatClient client, Action<List<Payload>> composer, string? sender = null, XivChatType? type = null)
    {
    ...
    public static void Print(this IChatClient client, string? sender = null, XivChatType? type = null, params Payload[] payloads)
    {
        client.Print(new SeString(payloads), sender, type);
    }
    ...
    public static void PrintError(this IChatClient client, Action<List<Payload>> composer, string? sender = null, XivChatType? type = null)
    {
        var payloads = new List<Payload>();
        composer(payloads);
        client.PrintError(new SeString(payloads), sender, type);
    ...
    public static void PrintError(this IChatClient client, string? sender = null, XivChatType? type = null, params Payload[] payloads)
    {
        client.PrintError(new SeString(payloads), sender, type);
    }
